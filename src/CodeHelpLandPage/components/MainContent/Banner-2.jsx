...
const dataContainer = [
    {num: '998', title: 'Subscribers', platform: 'Youtube'},
    {num: '6', title: 'Followers', platform: 'Twitter'},
    {num: '135', title: 'Followers', platform: 'Instagram'},
    {num: '800', title: 'Followers', platform: 'LinkedIn'},
]
...
const Banner_2 = () => {
    ...
    return (
        <>
            <div className='bg-blue-900 relative w-full md:px-[5rem] py-16 flex items-center justify-center'>
                <div>

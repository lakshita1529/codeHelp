            ...
            <div className='bg-[#090c1a] pb-[4rem] relative'>
                ...
                <div className='relative'>
                    ...
                    <div className='flex flex-col items-center justify-center gap-y-8 mt-12'>
                        <motion.img 
                        src="https://i.ytimg.com/vi/4dq11Hx1cmI/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLCPawhtJ2VDSvc-hMEo8yZOQF9UAQ"
                        ...
                        <div className='flex flex-col items-center justify-center gap-y-4'>
                            <p className='font-mooli tracking-wider text-white font-bold text-[1.2rem] sm:text-2xl lg:text-3xl'>Love Babbar</p>
                            <p className='text-gray-500 font-semibold text-xl lg:text-[1.7rem] font-lato tracking-wider'>Founder</p>
                        </div>
                    </div>
